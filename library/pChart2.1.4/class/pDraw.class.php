...
class pDraw
{
    ...
    function drawRoundedRectangle($X1, $Y1, $X2, $Y2, $Radius, $Format = "")
    {
        ...
        for ($i = 0; $i <= 90; $i = $i + $Step) {
            ...
            $this->drawAntialiasPixel($X, $Y, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
    ...
    function drawRoundedFilledRectangle($X1, $Y1, $X2, $Y2, $Radius, $Format = "")
    {
        ...
        if ($this->Shadow && $this->ShadowX != 0 && $this->ShadowY != 0) {
            $this->Shadow = FALSE;
            $this->drawRoundedFilledRectangle($X1 + $this->ShadowX, $Y1 + $this->ShadowY, $X2 + $this->ShadowX, $Y2 + $this->ShadowY, $Radius, array(
                "R" => $this->ShadowR,
                "G" => $this->ShadowG,
                "B" => $this->ShadowB,
                "Alpha" => $this->Shadowa
        ...
        $Radius++;
        $this->drawRoundedRectangle($X1, $Y1, $X2 + 1, $Y2 - 1, $Radius, array(
            "R" => $BorderR,
            "G" => $BorderG,
            "B" => $BorderB,
            "Alpha" => $Alpha
    ...
    function drawRoundedFilledRectangle_deprecated($X1, $Y1, $X2, $Y2, $Radius, $Format = "")
    {
        ...
        $this->drawFilledRectangle($X1 - $XOffset1, $YTop, $X2 + $XOffset2, $YBottom, array(
            "R" => $R,
            "G" => $G,
            "B" => $B,
            "Alpha" => $Alpha,
        ...
        $this->drawRoundedRectangle($X1, $Y1, $X2, $Y2, $Radius, array(
            "R" => $BorderR,
            "G" => $BorderG,
            "B" => $BorderB,
            "Alpha" => $Alpha
    ...
    function drawRectangle($X1, $Y1, $X2, $Y2, $Format = "")
    {
        ...
        if ($this->Antialias) {
            if ($NoAngle) {
                $this->drawLine($X1 + 1, $Y1, $X2 - 1, $Y1, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                $this->drawLine($X2, $Y1 + 1, $X2, $Y2 - 1, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                $this->drawLine($X2 - 1, $Y2, $X1 + 1, $Y2, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                $this->drawLine($X1, $Y1 + 1, $X1, $Y2 - 1, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                $this->drawLine($X2, $Y1, $X2, $Y2, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                $this->drawLine($X1, $Y1, $X1, $Y2, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
    ...
    function drawFilledRectangle($X1, $Y1, $X2, $Y2, $Format = "")
    {
        ...
        if ($this->Shadow && $this->ShadowX != 0 && $this->ShadowY != 0) {
            $this->Shadow = FALSE;
            $this->drawFilledRectangle($X1 + $this->ShadowX, $Y1 + $this->ShadowY, $X2 + $this->ShadowX, $Y2 + $this->ShadowY, array(
                "R" => $this->ShadowR,
                "G" => $this->ShadowG,
                "B" => $this->ShadowB,
                "Alpha" => $this->Shadowa,
        ...
        if ($BorderR != -1)
            $this->drawRectangle($X1, $Y1, $X2, $Y2, array(
                "R" => $BorderR,
                "G" => $BorderG,
                "B" => $BorderB,
                "Alpha" => $BorderAlpha,
    ...
    function drawBezier($X1, $Y1, $X2, $Y2, $Xv1, $Yv1, $Xv2, $Yv2, $Format = "")
    {
        ...
        if (!$NoDraw) {
            ...
            if ($ShowC && !$PathOnly) {
                ...
                $this->drawLine($X1, $Y1, $X2, $Y2, array(
                    "R" => 0,
                    "G" => 0,
                    "B" => 0,
                    "Alpha" => 30
            ...
            foreach ($Q as $Key => $Point) {
                ...
                if ($LastX != NULL && $LastY != NULL && !$PathOnly)
                    list($Cpt, $Mode) = $this->drawLine($LastX, $LastY, $X, $Y, array(
                        "R" => $R,
                        "G" => $G,
                        "B" => $B,
                        "Alpha" => $Alpha,
    ...
    function drawCircle($Xc, $Yc, $Height, $Width, $Format = "")
    {
        ...
        if ($this->Shadow && $this->ShadowX != 0 && $this->ShadowY != 0) {
            $this->Shadow = FALSE;
            $this->drawCircle($Xc + $this->ShadowX, $Yc + $this->ShadowY, $Height, $Width, array(
                "R" => $this->ShadowR,
                "G" => $this->ShadowG,
                "B" => $this->ShadowB,
                "Alpha" => $this->Shadowa,
    ...
    function drawFilledCircle($X, $Y, $Radius, $Format = "")
    {
        ...
        if ($this->Shadow && $this->ShadowX != 0 && $this->ShadowY != 0) {
            $this->Shadow = FALSE;
            $this->drawFilledCircle($X + $this->ShadowX, $Y + $this->ShadowY, $Radius, array(
                "R" => $this->ShadowR,
                "G" => $this->ShadowG,
                "B" => $this->ShadowB,
                "Alpha" => $this->Shadowa,
        ...
        if ($this->Antialias)
            $this->drawCircle($X, $Y, $Radius, $Radius, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha,
    ...
    function drawGradientArea($X1, $Y1, $X2, $Y2, $Direction, $Format = "")
    {
        ...
        if ($StartR == $EndR && $StartG == $EndG && $StartB == $EndB) {
            $this->drawFilledRectangle($X1, $Y1, $X2, $Y2, array(
                "R" => $StartR,
                "G" => $StartG,
                "B" => $StartB,
                "Alpha" => $Alpha
    ...
    function drawFromPicture($PicType, $FileName, $X, $Y)
    {
        if (file_exists($FileName)) {
            ...
            if ($this->Shadow && $this->ShadowX != 0 && $this->ShadowY != 0) {
                $this->Shadow = FALSE;
                if ($PicType == 3)
                    $this->drawFilledRectangle($X + $this->ShadowX, $Y + $this->ShadowY, $X + $Width + $this->ShadowX, $Y + $Height + $this->ShadowY, array(
                        "R" => $this->ShadowR,
                        "G" => $this->ShadowG,
                        "B" => $this->ShadowB,
                        "Alpha" => $this->Shadowa
    ...
    function drawArrow($X1, $Y1, $X2, $Y2, $Format = "")
    {
        ...
        if ($this->Shadow && $this->ShadowX != 0 && $this->ShadowY != 0) {
            $this->Shadow = FALSE;
            $this->drawArrow($X1 + $this->ShadowX, $Y1 + $this->ShadowY, $X2 + $this->ShadowX, $Y2 + $this->ShadowY, array(
                "FillR" => $this->ShadowR,
                "FillG" => $this->ShadowG,
                "FillB" => $this->ShadowB,
                "Alpha" => $this->Shadowa,
        ...
        $this->drawLine($Points[0], $Points[1], $Points[2], $Points[3], array(
            "R" => $BorderR,
            "G" => $BorderG,
            "B" => $BorderB,
            "Alpha" => $Alpha
        ));
        $this->drawLine($Points[2], $Points[3], $Points[4], $Points[5], array(
            "R" => $BorderR,
            "G" => $BorderG,
            "B" => $BorderB,
            "Alpha" => $Alpha
        ));
        $this->drawLine($Points[0], $Points[1], $Points[4], $Points[5], array(
            "R" => $BorderR,
            "G" => $BorderG,
            "B" => $BorderB,
            "Alpha" => $Alpha
        ...
        if ($TwoHeads) {
            ...
            $this->drawLine($TailX, $TailY, $TailX2, $TailY2, array(
                "R" => $BorderR,
                "G" => $BorderG,
                "B" => $BorderB,
                "Alpha" => $Alpha,
            ...
            $this->drawLine($X1, $Y1, $TailX, $TailY, array(
                "R" => $BorderR,
                "G" => $BorderG,
                "B" => $BorderB,
                "Alpha" => $Alpha,
    ...
    function drawArrowLabel($X1, $Y1, $Text, $Format = "")
    {
        ...
        if ($Angle > 0 && $Angle < 180) {
            $this->drawLine($X2, $Y2, $X2 - $TxtWidth, $Y2, array(
                "R" => $BorderR,
                "G" => $BorderG,
                "B" => $BorderB,
                "Alpha" => $Alpha,
            ...
            if ($Position == POSITION_TOP)
                $this->drawText($X2, $Y2 - 2, $Text, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $Alpha,
                ...
                $this->drawText($X2, $Y2 + 4, $Text, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $Alpha,
    ...
    function drawProgress($X, $Y, $Percent, $Format = "")
    {
        ...
        if ($Orientation == ORIENTATION_VERTICAL) {
            ...
            $this->drawFilledRectangle($X, $Y, $X + $Width, $Y - $Height, array(
                "R" => $BoxBackR,
                "G" => $BoxBackG,
                "B" => $BoxBackB,
                "BorderR" => $BoxBorderR,
            ...
            if ($RFade != -1 && $GFade != -1 && $BFade != -1) {
                ...
                if ($Surrounding)
                    $this->drawRectangle($X + 1, $Y - 1, $X + $Width - 1, $Y - $InnerHeight, array(
                        "R" => 255,
                        "G" => 255,
                        "B" => 255,
                        "Alpha" => $Surrounding
                ...
                $this->drawFilledRectangle($X + 1, $Y - 1, $X + $Width - 1, $Y - $InnerHeight, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "BorderR" => $BorderR,
            ...
            if ($ShowLabel && $LabelPos == LABEL_POS_BOTTOM) {
                $this->drawText($X + ($Width / 2), $Y + $Margin, $Percent . "%", array(
                    "Align" => TEXT_ALIGN_TOPMIDDLE
                ));
            }
            if ($ShowLabel && $LabelPos == LABEL_POS_TOP) {
                $this->drawText($X + ($Width / 2), $Y - $Height - $Margin, $Percent . "%", array(
                    "Align" => TEXT_ALIGN_BOTTOMMIDDLE
                ));
            }
            if ($ShowLabel && $LabelPos == LABEL_POS_INSIDE) {
                $this->drawText($X + ($Width / 2), $Y - $InnerHeight - $Margin, $Percent . "%", array(
                    "Align" => TEXT_ALIGN_MIDDLELEFT,
                    "Angle" => 90
                ));
            }
            if ($ShowLabel && $LabelPos == LABEL_POS_CENTER) {
                $this->drawText($X + ($Width / 2), $Y - ($Height / 2), $Percent . "%", array(
            ...
            if ($RFade != -1 && $GFade != -1 && $BFade != -1) {
                ...
                if ($Surrounding)
                    $this->drawRectangle($X + 1, $Y + 1, $X + $InnerWidth, $Y + $Height - 1, array(
                        "R" => 255,
                        "G" => 255,
                        "B" => 255,
                        "Alpha" => $Surrounding
                ...
                $this->drawFilledRectangle($X + 1, $Y + 1, $X + $InnerWidth, $Y + $Height - 1, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "BorderR" => $BorderR,
            ...
            if ($ShowLabel && $LabelPos == LABEL_POS_LEFT) {
                $this->drawText($X - $Margin, $Y + ($Height / 2), $Percent . "%", array(
                    "Align" => TEXT_ALIGN_MIDDLERIGHT
                ));
            }
            if ($ShowLabel && $LabelPos == LABEL_POS_RIGHT) {
                $this->drawText($X + $Width + $Margin, $Y + ($Height / 2), $Percent . "%", array(
                    "Align" => TEXT_ALIGN_MIDDLELEFT
                ));
            }
            if ($ShowLabel && $LabelPos == LABEL_POS_CENTER) {
            ...
            if ($ShowLabel && $LabelPos == LABEL_POS_INSIDE) {
                $this->drawText($X + $InnerWidth + $Margin, $Y + ($Height / 2), $Percent . "%", array(
                    "Align" => TEXT_ALIGN_MIDDLELEFT
                ));
            }
        }
    ...
    function drawLegend($X, $Y, $Format = "")
    {
        ...
        if ($Style == LEGEND_ROUND)
            $this->drawRoundedFilledRectangle($Boundaries["L"] - $Margin, $Boundaries["T"] - $Margin, $Boundaries["R"] + $Margin, $Boundaries["B"] + $Margin, $Margin, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha,
        ...
        elseif ($Style == LEGEND_BOX)
            $this->drawFilledRectangle($Boundaries["L"] - $Margin, $Boundaries["T"] - $Margin, $Boundaries["R"] + $Margin, $Boundaries["B"] + $Margin, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha,
            ...
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if (isset($Serie["Picture"])) {
                    ...
                    if ($Family == LEGEND_FAMILY_BOX) {
                        ...
                        $this->drawFilledRectangle($X + 1 + $XOffset, $Y + 1 + $YOffset, $X + $BoxWidth + $XOffset + 1, $Y + $BoxHeight + 1 + $YOffset, array(
                            "R" => 0,
                            "G" => 0,
                            "B" => 0,
                            "Alpha" => 20
                        ));
                        $this->drawFilledRectangle($X + $XOffset, $Y + $YOffset, $X + $BoxWidth + $XOffset, $Y + $BoxHeight + $YOffset, array(
                            "R" => $R,
                            "G" => $G,
                            "B" => $B,
                            "Surrounding" => 20
                        ...
                        $this->drawFilledCircle($X + 1 + $IconAreaWidth / 2, $Y + 1 + $IconAreaHeight / 2, min($IconAreaHeight / 2, $IconAreaWidth / 2), array(
                            "R" => 0,
                            "G" => 0,
                            "B" => 0,
                            "Alpha" => 20
                        ));
                        $this->drawFilledCircle($X + $IconAreaWidth / 2, $Y + $IconAreaHeight / 2, min($IconAreaHeight / 2, $IconAreaWidth / 2), array(
                            "R" => $R,
                            "G" => $G,
                            "B" => $B,
                            "Surrounding" => 20
                        ...
                        $this->drawLine($X + 1, $Y + 1 + $IconAreaHeight / 2, $X + 1 + $IconAreaWidth, $Y + 1 + $IconAreaHeight / 2, array(
                            "R" => 0,
                            "G" => 0,
                            "B" => 0,
                            "Alpha" => 20,
                        ...
                        $this->drawLine($X, $Y + $IconAreaHeight / 2, $X + $IconAreaWidth, $Y + $IconAreaHeight / 2, array(
                            "R" => $R,
                            "G" => $G,
                            "B" => $B,
                            "Ticks" => $Ticks,
                ...
                if ($Mode == LEGEND_VERTICAL) {
                    $Lines = preg_split("/\n/", $Serie["Description"]);
                    foreach ($Lines as $Key => $Value)
                        $this->drawText($X + $IconAreaWidth + 4, $Y + $IconAreaHeight / 2 + (($this->FontSize + 3) * $Key), $Value, array(
                            "R" => $FontR,
                            "G" => $FontG,
                            "B" => $FontB,
                            "Align" => TEXT_ALIGN_MIDDLELEFT,
                    ...
                    $Width = "";
                    foreach ($Lines as $Key => $Value) {
                        $BoxArray = $this->drawText($X + $IconAreaWidth + 4, $Y + $IconAreaHeight / 2 + (($this->FontSize + 3) * $Key), $Value, array(
                            "R" => $FontR,
                            "G" => $FontG,
                            "B" => $FontB,
                            "Align" => TEXT_ALIGN_MIDDLELEFT,
                ...
                if ($Pos == SCALE_POS_LEFTRIGHT) {
                    if ($Parameters["Position"] == AXIS_POSITION_BOTTOM) {
                        ...
                        if (!$RemoveXAxis) {
                            if ($Floating) {
                                ...
                                $this->drawLine($this->GraphAreaX1 + $Parameters["Margin"], $AxisPos["B"], $this->GraphAreaX2 - $Parameters["Margin"], $AxisPos["B"], array(
                                    "R" => $AxisR,
                                    "G" => $AxisG,
                                    "B" => $AxisB,
                                    "Alpha" => $AxisAlpha
                                ...
                                $FloatingOffset = 0;
                                $this->drawLine($this->GraphAreaX1, $AxisPos["B"], $this->GraphAreaX2, $AxisPos["B"], array(
                                    "R" => $AxisR,
                                    "G" => $AxisG,
                                    "B" => $AxisB,
                                    "Alpha" => $AxisAlpha
                            ...
                            if ($DrawArrows) {
                                $this->drawArrow($this->GraphAreaX2 - $Parameters["Margin"], $AxisPos["B"], $this->GraphAreaX2 + ($ArrowSize * 2), $AxisPos["B"], array(
                                    "FillR" => $AxisR,
                                    "FillG" => $AxisG,
                                    "FillB" => $AxisB,
                                    "Size" => $ArrowSize
                        ...
                        for ($i = 0; $i <= $Parameters["Rows"]; $i++) {
                            ...
                            if ($this->isValidLabel($Value, $LastValue, $LabelingMethod, $ID, $LabelSkip) && !$RemoveXAxis) {
                                $Bounds    = $this->drawText($XPos, $YPos + $OuterTickWidth + $YLabelOffset, $Value, array(
                                    "Angle" => $LabelRotation,
                                    "Align" => $LabelAlign
                                ));
                            ...
                            if ($Skipped) {
                                ...
                                if ($DrawXLines && ($XPos != $this->GraphAreaX1 && $XPos != $this->GraphAreaX2)) {
                                    $this->drawLine($XPos, $this->GraphAreaY1 + $FloatingOffset, $XPos, $this->GraphAreaY2 - $FloatingOffset, array(
                                        "R" => $GridR,
                                        "G" => $GridG,
                                        "B" => $GridB,
                                        "Alpha" => $GridAlpha,
                                ...
                                if (($InnerTickWidth != 0 || $OuterTickWidth != 0) && !$RemoveXAxis) {
                                    $this->drawLine($XPos, $YPos - $InnerTickWidth, $XPos, $YPos + $OuterTickWidth, array(
                                        "R" => $TickR,
                                        "G" => $TickG,
                                        "B" => $TickB,
                                        "Alpha" => $TickAlpha
                        ...
                        if (isset($Parameters["Name"]) && !$RemoveXAxis) {
                            ...
                            $Bounds    = $this->drawText($XPos, $YPos, $Parameters["Name"], array(
                                "Align" => TEXT_ALIGN_TOPMIDDLE
                            ));
                        ...
                        if (!$RemoveXAxis) {
                            if ($Floating) {
                                $FloatingOffset = $YMargin;
                                $this->drawLine($this->GraphAreaX1 + $Parameters["Margin"], $AxisPos["T"], $this->GraphAreaX2 - $Parameters["Margin"], $AxisPos["T"], array(
                                    "R" => $AxisR,
                                    "G" => $AxisG,
                                    "B" => $AxisB,
                                    "Alpha" => $AxisAlpha
                                ...
                                $FloatingOffset = 0;
                                $this->drawLine($this->GraphAreaX1, $AxisPos["T"], $this->GraphAreaX2, $AxisPos["T"], array(
                                    "R" => $AxisR,
                                    "G" => $AxisG,
                                    "B" => $AxisB,
                                    "Alpha" => $AxisAlpha
                            ...
                            if ($DrawArrows) {
                                $this->drawArrow($this->GraphAreaX2 - $Parameters["Margin"], $AxisPos["T"], $this->GraphAreaX2 + ($ArrowSize * 2), $AxisPos["T"], array(
                                    "FillR" => $AxisR,
                                    "FillG" => $AxisG,
                                    "FillB" => $AxisB,
                                    "Size" => $ArrowSize
                    ...
                    if ($Parameters["Position"] == AXIS_POSITION_LEFT) {
                        ...
                        if (!$RemoveXAxis) {
                            if ($Floating) {
                                $FloatingOffset = $YMargin;
                                $this->drawLine($AxisPos["L"], $this->GraphAreaY1 + $Parameters["Margin"], $AxisPos["L"], $this->GraphAreaY2 - $Parameters["Margin"], array(
                                    "R" => $AxisR,
                                    "G" => $AxisG,
                                    "B" => $AxisB,
                                    "Alpha" => $AxisAlpha
                                ...
                                $FloatingOffset = 0;
                                $this->drawLine($AxisPos["L"], $this->GraphAreaY1, $AxisPos["L"], $this->GraphAreaY2, array(
                                    "R" => $AxisR,
                                    "G" => $AxisG,
                                    "B" => $AxisB,
                                    "Alpha" => $AxisAlpha
                            ...
                            if ($DrawArrows) {
                                $this->drawArrow($AxisPos["L"], $this->GraphAreaY2 - $Parameters["Margin"], $AxisPos["L"], $this->GraphAreaY2 + ($ArrowSize * 2), array(
                                    "FillR" => $AxisR,
                                    "FillG" => $AxisG,
                                    "FillB" => $AxisB,
                                    "Size" => $ArrowSize
                        ...
                        for ($i = 0; $i <= $Parameters["Rows"]; $i++) {
                            ...
                            $Skipped = TRUE;
                            if ($this->isValidLabel($Value, $LastValue, $LabelingMethod, $ID, $LabelSkip) && !$RemoveXAxis) {
                                $Bounds    = $this->drawText($XPos - $OuterTickWidth + $XLabelOffset, $YPos, $Value, array(
                                    "Angle" => $LabelRotation,
                                    "Align" => $LabelAlign
                                ));
                            ...
                            if ($Skipped) {
                                ...
                                if ($DrawXLines && ($YPos != $this->GraphAreaY1 && $YPos != $this->GraphAreaY2)) {
                                    $this->drawLine($this->GraphAreaX1 + $FloatingOffset, $YPos, $this->GraphAreaX2 - $FloatingOffset, $YPos, array(
                                        "R" => $GridR,
                                        "G" => $GridG,
                                        "B" => $GridB,
                                        "Alpha" => $GridAlpha,
                                ...
                                if (($InnerTickWidth != 0 || $OuterTickWidth != 0) && !$RemoveXAxis) {
                                    $this->drawLine($XPos - $OuterTickWidth, $YPos, $XPos + $InnerTickWidth, $YPos, array(
                                        "R" => $TickR,
                                        "G" => $TickG,
                                        "B" => $TickB,
                                        "Alpha" => $TickAlpha
                        ...
                        if (!$RemoveXAxis) {
                            if ($Floating) {
                                $FloatingOffset = $YMargin;
                                $this->drawLine($AxisPos["R"], $this->GraphAreaY1 + $Parameters["Margin"], $AxisPos["R"], $this->GraphAreaY2 - $Parameters["Margin"], array(
                                    "R" => $AxisR,
                                    "G" => $AxisG,
                                    "B" => $AxisB,
                                    "Alpha" => $AxisAlpha
                                ...
                                $FloatingOffset = 0;
                                $this->drawLine($AxisPos["R"], $this->GraphAreaY1, $AxisPos["R"], $this->GraphAreaY2, array(
                                    "R" => $AxisR,
                                    "G" => $AxisG,
                                    "B" => $AxisB,
                                    "Alpha" => $AxisAlpha
                            ...
                            if ($DrawArrows) {
                                $this->drawArrow($AxisPos["R"], $this->GraphAreaY2 - $Parameters["Margin"], $AxisPos["R"], $this->GraphAreaY2 + ($ArrowSize * 2), array(
                                    "FillR" => $AxisR,
                                    "FillG" => $AxisG,
                                    "FillB" => $AxisB,
                                    "Size" => $ArrowSize
            ...
            if ($Parameters["Identity"] == AXIS_Y) {
                if ($Pos == SCALE_POS_LEFTRIGHT) {
                    if ($Parameters["Position"] == AXIS_POSITION_LEFT) {
                        ...
                        if ($DrawArrows) {
                            $this->drawArrow($AxisPos["L"], $this->GraphAreaY1 + $Parameters["Margin"], $AxisPos["L"], $this->GraphAreaY1 - ($ArrowSize * 2), array(
                                "FillR" => $AxisR,
                                "FillG" => $AxisG,
                                "FillB" => $AxisB,
                                "Size" => $ArrowSize
                        ...
                        for ($i = 0; $i <= $Parameters["Rows"]; $i++) {
                            ...
                            if ($DrawSubTicks && $i != $Parameters["Rows"])
                                $this->drawLine($XPos - $OuterSubTickWidth, $YPos - $SubTicksSize, $XPos + $InnerSubTickWidth, $YPos - $SubTicksSize, array(
                                    "R" => $SubTickR,
                                    "G" => $SubTickG,
                                    "B" => $SubTickB,
                                    "Alpha" => $SubTickAlpha
                            ...
                            $Bounds  = $this->drawText($XPos - $OuterTickWidth - 2, $YPos, $Value, array(
                                "Align" => TEXT_ALIGN_MIDDLERIGHT
                            ));
                        ...
                        if ($DrawArrows) {
                            $this->drawArrow($AxisPos["R"], $this->GraphAreaY1 + $Parameters["Margin"], $AxisPos["R"], $this->GraphAreaY1 - ($ArrowSize * 2), array(
                                "FillR" => $AxisR,
                                "FillG" => $AxisG,
                                "FillB" => $AxisB,
                                "Size" => $ArrowSize
                        ...
                        for ($i = 0; $i <= $Parameters["Rows"]; $i++) {
                            ...
                            $this->drawLine($XPos - $InnerTickWidth, $YPos, $XPos + $OuterTickWidth, $YPos, array(
                                "R" => $TickR,
                                "G" => $TickG,
                                "B" => $TickB,
                                "Alpha" => $TickAlpha
                    ...
                    if ($Parameters["Position"] == AXIS_POSITION_TOP) {
                        ...
                        for ($i = 0; $i <= $Parameters["Rows"]; $i++) {
                            ...
                            if ($DrawSubTicks && $i != $Parameters["Rows"])
                                $this->drawLine($XPos + $SubTicksSize, $YPos - $OuterSubTickWidth, $XPos + $SubTicksSize, $YPos + $InnerSubTickWidth, array(
                                    "R" => $SubTickR,
                                    "G" => $SubTickG,
                                    "B" => $SubTickB,
                                    "Alpha" => $SubTickAlpha
                            ...
                            $this->drawLine($XPos, $YPos - $OuterTickWidth, $XPos, $YPos + $InnerTickWidth, array(
                                "R" => $TickR,
                                "G" => $TickG,
                                "B" => $TickB,
                                "Alpha" => $TickAlpha
                            ));
                            $Bounds    = $this->drawText($XPos, $YPos - $OuterTickWidth - 2, $Value, array(
                                "Align" => TEXT_ALIGN_BOTTOMMIDDLE
                            ));
    ...
    function computeScale($XMin, $XMax, $MaxDivs, $Factors, $AxisID = 0)
    {
        ...
        foreach ($Factors as $Key => $Factor)
            $Results[$Factor] = $this->processScale($XMin, $XMax, $MaxDivs, array(
                $Factor
            ), $AxisID);
    ...
    function drawXThreshold($Value, $Format = "")
    {
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            ...
            if ($XPos >= $this->GraphAreaX1 + $AbscissaMargin && $XPos <= $this->GraphAreaX2 - $AbscissaMargin) {
                $this->drawLine($XPos, $YPos1, $XPos, $YPos2, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                if ($Wide) {
                    $this->drawLine($XPos - 1, $YPos1, $XPos - 1, $YPos2, array(
                        "R" => $R,
                        "G" => $G,
                        "B" => $B,
            ...
            if ($XPos >= $this->GraphAreaY1 + $AbscissaMargin && $XPos <= $this->GraphAreaY2 - $AbscissaMargin) {
                $this->drawLine($YPos1, $XPos, $YPos2, $XPos, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                if ($Wide) {
                    $this->drawLine($YPos1, $XPos - 1, $YPos2, $XPos - 1, array(
                        "R" => $R,
                        "G" => $G,
                        "B" => $B,
                        "Alpha" => $Alpha / $WideFactor,
    ...
    function drawXThresholdArea($Value1, $Value2, $Format = "")
    {
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            ...
            $this->drawFilledRectangle($XPos1, $YPos1, $XPos2, $YPos2, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
            ...
            if ($Border) {
                $this->drawLine($XPos1, $YPos1, $XPos1, $YPos2, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
                ...
                $this->drawLine($XPos2, $YPos1, $XPos2, $YPos2, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
            ...
            if ($AreaName != NULL) {
                ...
                $this->Shadow = $RestoreShadow;
                $this->drawText($XPos, $YPos, $AreaName, array(
                    "R" => $NameR,
                    "G" => $NameG,
                    "B" => $NameB,
                    "Alpha" => $NameAlpha,
            ...
            $this->drawFilledRectangle($YPos1, $XPos1, $YPos2, $XPos2, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
            ...
            if ($Border) {
                $this->drawLine($YPos1, $XPos1, $YPos2, $XPos1, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
                ...
                $this->drawLine($YPos1, $XPos2, $YPos2, $XPos2, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
            ...
            if ($AreaName != NULL) {
                ...
                $this->Shadow = $RestoreShadow;
                $this->drawText($YPos, $XPos, $AreaName, array(
                    "R" => $NameR,
                    "G" => $NameG,
                    "B" => $NameB,
                    "Alpha" => $NameAlpha,
    ...
    function drawThreshold($Value, $Format = "")
    {
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            $YPos = $this->scaleComputeY($Value, array(
                "AxisID" => $AxisID
            ));
            if ($YPos >= $this->GraphAreaY1 + $Data["Axis"][$AxisID]["Margin"] && $YPos <= $this->GraphAreaY2 - $Data["Axis"][$AxisID]["Margin"]) {
                ...
                $this->drawLine($X1, $YPos, $X2, $YPos, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                if ($Wide) {
                    $this->drawLine($X1, $YPos - 1, $X2, $YPos - 1, array(
                        "R" => $R,
                        "G" => $G,
                        "B" => $B,
                        "Alpha" => $Alpha / $WideFactor,
        ...
        if ($Data["Orientation"] == SCALE_POS_TOPBOTTOM) {
            $XPos = $this->scaleComputeY($Value, array(
                "AxisID" => $AxisID
            ));
            if ($XPos >= $this->GraphAreaX1 + $Data["Axis"][$AxisID]["Margin"] && $XPos <= $this->GraphAreaX2 - $Data["Axis"][$AxisID]["Margin"]) {
                ...
                $this->drawLine($XPos, $Y1, $XPos, $Y2, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha,
                ...
                if ($Wide) {
                    $this->drawLine($XPos - 1, $Y1, $XPos - 1, $Y2, array(
                        "R" => $R,
                        "G" => $G,
                        "B" => $B,
                        "Alpha" => $Alpha / $WideFactor,
    ...
    function drawThresholdArea($Value1, $Value2, $Format = "")
    {
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            ...
            $YPos1 = $this->scaleComputeY($Value1, array(
                "AxisID" => $AxisID
            ));
            $YPos2 = $this->scaleComputeY($Value2, array(
                "AxisID" => $AxisID
            ));
            ...
            if ($Border) {
                $this->drawLine($XPos1, $YPos1, $XPos2, $YPos1, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
                ...
                $this->drawLine($XPos1, $YPos2, $XPos2, $YPos2, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
            ...
            $XPos1 = $this->scaleComputeY($Value1, array(
                "AxisID" => $AxisID
            ));
            $XPos2 = $this->scaleComputeY($Value2, array(
                "AxisID" => $AxisID
            ));
    ...
    function writeBounds($Type = BOUND_BOTH, $Format = NULL)
    {
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"] && !isset($ExcludedSeries[$SerieName])) {
                ...
                $PosArray = $this->scaleComputeY($Serie["Data"], array(
                    "AxisID" => $Serie["Axis"]
                ));
            ...
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        if ($DisplayValues)
                            $this->drawText($X, $Y - $DisplayOffset - $SerieWeight - $BorderSize - $PicOffset, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                "R" => $DisplayR,
                                "G" => $DisplayG,
                                "B" => $DisplayB,
                                "Align" => TEXT_ALIGN_BOTTOMMIDDLE
                    ...
                    foreach ($PosArray as $Key => $X) {
                        if ($DisplayValues)
                            $this->drawText($X + $DisplayOffset + $SerieWeight + $BorderSize + $PicOffset, $Y, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                "Angle" => 270,
                                "R" => $DisplayR,
                                "G" => $DisplayG,
                                "B" => $DisplayB,
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        if ($DisplayValues)
                            $this->drawText($X, $Y - $DisplayOffset, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                "R" => $DisplayR,
                                "G" => $DisplayG,
                                "B" => $DisplayB,
                                "Align" => TEXT_ALIGN_BOTTOMMIDDLE
                        ...
                        if ($Y == VOID && $LastY != NULL) {
                            $this->drawSpline($WayPoints, array(
                                "Force" => $Force,
                                "R" => $R,
                                "G" => $G,
                                "B" => $B,
    ...
    function drawFilledSplineChart($Format = NULL)
    {
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($AroundZero) {
                    $YZero = $this->scaleComputeY(0, array(
                        "AxisID" => $Serie["Axis"]
                    ));
                }
                ...
                if ($Threshold != NULL) {
                    foreach ($Threshold as $Key => $Params) {
                        $Threshold[$Key]["MinX"] = $this->scaleComputeY($Params["Min"], array(
                            "AxisID" => $Serie["Axis"]
                        ));
                        $Threshold[$Key]["MaxX"] = $this->scaleComputeY($Params["Max"], array(
                            "AxisID" => $Serie["Axis"]
                        ));
                    }
                }
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        ...
                        if ($Y == VOID) {
                            $Area = $this->drawSpline($WayPoints, array(
                                "Force" => $Force,
                                "PathOnly" => TRUE
                            ));
                            ...
                            if ($Area != "") {
                                foreach ($Area as $key => $Points) {
                                    ...
                                    $this->drawPolygonChart($Corners, array(
                                        "R" => $R,
                                        "G" => $G,
                                        "B" => $B,
                                        "Alpha" => $Alpha / 2,
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                            ...
                            $this->drawText($X, $Y - $Offset - $Weight, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                "R" => $DisplayR,
                                "G" => $DisplayG,
                                "B" => $DisplayB,
                                "Align" => $Align
                        ...
                        if ($Y != VOID && $LastX != NULL && $LastY != NULL)
                            $this->drawLine($LastX, $LastY, $X, $Y, array(
                                "R" => $R,
                                "G" => $G,
                                "B" => $B,
                                "Alpha" => $Alpha,
                    ...
                    foreach ($PosArray as $Key => $X) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                            $this->drawText($X + $DisplayOffset + $Weight, $Y, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                "Angle" => 270,
                                "R" => $DisplayR,
                                "G" => $DisplayG,
                                "B" => $DisplayB,
    ...
    function drawZoneChart($SerieA, $SerieB, $Format = NULL)
    {
        ...
        $PosArrayA = $this->scaleComputeY($SerieAData, array(
            "AxisID" => $AxisID
        ));
        $PosArrayB = $this->scaleComputeY($SerieBData, array(
            "AxisID" => $AxisID
        ));
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            ...
            $this->drawPolygonChart($Bounds, array(
                "R" => $AreaR,
                "G" => $AreaG,
                "B" => $AreaB,
                "Alpha" => $AreaAlpha
            ...
            for ($i = 0; $i <= count($BoundsA) - 4; $i = $i + 2) {
                $this->drawLine($BoundsA[$i], $BoundsA[$i + 1], $BoundsA[$i + 2], $BoundsA[$i + 3], array(
                    "R" => $LineR,
                    "G" => $LineG,
                    "B" => $LineB,
                    "Alpha" => $LineAlpha,
                ...
                $this->drawLine($BoundsB[$i], $BoundsB[$i + 1], $BoundsB[$i + 2], $BoundsB[$i + 3], array(
                    "R" => $LineR,
                    "G" => $LineG,
                    "B" => $LineB,
                    "Alpha" => $LineAlpha,
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $X) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                            ...
                            $this->drawText($X + $Offset + $Weight, $Y, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                "R" => $DisplayR,
                                "G" => $DisplayG,
                                "B" => $DisplayB,
                                "Align" => $Align
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                            ...
                            $this->drawText($X, $Y - $Offset, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                "R" => $DisplayR,
                                "G" => $DisplayG,
                                "B" => $DisplayB,
                                "Align" => $Align
                    ...
                    if ($this->Shadow) {
                        ...
                        foreach ($ShadowArea as $Key => $Points)
                            $this->drawPolygonChart($Points, array(
                                "R" => $this->ShadowR,
                                "G" => $this->ShadowG,
                                "B" => $this->ShadowB,
                                "Alpha" => $this->Shadowa
                    ...
                    foreach ($PosArray as $Key => $X) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                            ...
                            $this->drawText($X + $Offset, $Y, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                "Angle" => 270,
                                "R" => $DisplayR,
                                "G" => $DisplayG,
                                "B" => $DisplayB,
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($Floating0Value != NULL) {
                    $YZero = $this->scaleComputeY($Floating0Value, array(
                        "AxisID" => $Serie["Axis"]
                    ));
                } else {
                    $YZero = $this->scaleComputeY(0, array(
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y2) {
                        if ($Floating0Serie != NULL) {
                            ...
                            $YZero = $this->scaleComputeY($Value, array(
                                "AxisID" => $Serie["Axis"]
                            ));
                            if ($YZero > $this->GraphAreaY2 - 1) {
                                $YZero = $this->GraphAreaY2 - 1;
                        ...
                        if ($Y2 != VOID) {
                            ...
                            if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                                ...
                                if ($DisplayPos == LABEL_POS_INSIDE && abs($TxtHeight) < abs($BarHeight)) {
                                    ...
                                    $this->drawText($CenterX, $CenterY, $Caption, array(
                                        "R" => $DisplayR,
                                        "G" => $DisplayG,
                                        "B" => $DisplayB,
                                        "Align" => TEXT_ALIGN_MIDDLEMIDDLE,
                                    ...
                                    $this->drawText($X + $XOffset + $XSize / 2, $Y2 - $Offset, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                        "R" => $DisplayR,
                                        "G" => $DisplayG,
                                        "B" => $DisplayB,
                                        "Align" => $Align,
                        ...
                        if ($X2 != VOID) {
                            ...
                            if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                                ...
                                if ($DisplayPos == LABEL_POS_INSIDE && abs($TxtWidth) < abs($BarWidth)) {
                                    ...
                                    $this->drawText($X2 + $Offset, $Y + $YOffset + $YSize / 2, $Caption, array(
                                        "R" => $DisplayR,
                                        "G" => $DisplayG,
                                        "B" => $DisplayB,
                                        "Align" => $Align,
                            ...
                            if ($DisplayValues) {
                                ...
                                if ($DisplayOrientation == ORIENTATION_HORIZONTAL || $DisplayOrientation == ORIENTATION_AUTO) {
                                    if ($TxtHeight < $BarHeight && $TxtWidth < $BarWidth) {
                                        $this->drawText($XCenter, $YCenter, $this->scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array(
                                            "R" => $DisplayR,
                                            "G" => $DisplayG,
                                            "B" => $DisplayB,
                                            "Align" => TEXT_ALIGN_MIDDLEMIDDLE,
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    if ($Caption) {
                        if ($CaptionLine) {
                            ...
                            if ($CaptionBox) {
                                $this->drawFilledRectangle($StartX, $YPos, $EndX, $YPos + $CaptionHeight, array(
                                    "R" => $CaptionFillR,
                                    "G" => $CaptionFillG,
                                    "B" => $CaptionFillB,
                            ...
                            $this->drawFilledRectangle($this->GraphAreaX1 - $CaptionWidth + $XMargin - $CaptionMargin, $YPos, $this->GraphAreaX1 - $CaptionMargin + $XMargin, $YPos + $CaptionHeight, array(
                                "R" => $R,
                                "G" => $G,
                                "B" => $B,
                                "BorderR" => $CaptionBorderR,
                    ...
                    if ($DrawBackground) {
                        $this->drawFilledRectangle($StartX - 1, $TopY - 1, $EndX + 1, $BottomY + 1, array(
                            "R" => $BackgroundR,
                            "G" => $BackgroundG,
                            "B" => $BackgroundB,
                    ...
                    if ($DrawBorder) {
                        $this->drawRectangle($StartX - 1, $TopY - 1, $EndX + 1, $BottomY + 1, array(
                            "R" => $BorderR,
                            "G" => $BorderG,
                            "B" => $BorderB,
                            "Alpha" => $BorderAlpha
                    ...
                    if ($Caption) {
                        ...
                        if ($CaptionLine) {
                            ...
                            if ($CaptionBox) {
                                $this->drawFilledRectangle($XPos, $StartY, $XPos + $CaptionHeight, $EndY, array(
                                    "R" => $CaptionFillR,
                                    "G" => $CaptionFillG,
                                    "B" => $CaptionFillB,
                                    "BorderR" => $CaptionBorderR,
                    ...
                    if ($DrawBackground) {
                        $this->drawFilledRectangle($TopX - 1, $StartY - 1, $BottomX + 1, $EndY + 1, array(
                            "R" => $BackgroundR,
                            "G" => $BackgroundG,
                            "B" => $BackgroundB,
                            "Alpha" => $BackgroundAlpha
                    ...
                    if ($DrawBorder) {
                        $this->drawRectangle($TopX - 1, $StartY - 1, $BottomX + 1, $EndY + 1, array(
                            "R" => $BorderR,
                            "G" => $BorderG,
                            "B" => $BorderB,
                            "Alpha" => $BorderAlpha
            ...
            if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                ...
                foreach ($SeriesName as $iKey => $SerieName) {
                    if (isset($Data["Series"][$SerieName]["Data"][$Index])) {
                        ...
                        $Y = floor($this->scaleComputeY($Value, array(
                            "AxisID" => $AxisID
                        )));
                        ...
                        if ($DrawPoint == LABEL_POINT_CIRCLE)
                            $this->drawFilledCircle($X, $Y, 3, array(
                                "R" => 255,
                                "G" => 255,
                                "B" => 255,
                                "BorderR" => 0,
                        ...
                        elseif ($DrawPoint == LABEL_POINT_BOX)
                            $this->drawFilledRectangle($X - 2, $Y - 2, $X + 2, $Y + 2, array(
                                "R" => 255,
                                "G" => 255,
                                "B" => 255,
                                "BorderR" => 0,
                ...
                if ($DrawVerticalLine) {
                    $this->drawLine($this->GraphAreaX1 + $Data["YMargin"], $Y, $this->GraphAreaX2 - $Data["YMargin"], $Y, array(
                        "R" => $VerticalLineR,
                        "G" => $VerticalLineG,
                        "B" => $VerticalLineB,
                        "Alpha" => $VerticalLineAlpha,
                ...
                foreach ($SeriesName as $Key => $SerieName) {
                    if (isset($Data["Series"][$SerieName]["Data"][$Index])) {
                        ...
                        $X = floor($this->scaleComputeY($Value, array(
                            "AxisID" => $AxisID
                        )));
    ...
    function drawLabelBox($X, $Y, $Title, $Captions, $Format = "")
    {
        ...
        if ($TitleMode == LABEL_TITLE_NOBACKGROUND && !$NoTitle) {
            ...
            $this->drawLine($XMin + $XMargin, $YPos + 1, $XMax - $XMargin, $YPos + 1, array(
                "R" => $GradientEndR,
                "G" => $GradientEndG,
                "B" => $GradientEndB,
                "Alpha" => $BoxAlpha
            ));
            $this->drawLine($XMin + $XMargin, $YPos, $XMax - $XMargin, $YPos, array(
                "R" => $GradientStartR,
                "G" => $GradientStartG,
                "B" => $GradientStartB,
                "Alpha" => $BoxAlpha
        ...
        if (!$NoTitle)
            $this->drawText($XMin + $VerticalMargin, $Y - 7 - $CaptionHeight - $HorizontalMargin * 2, $Title, array(
        ...
        foreach ($Captions as $Key => $Caption) {
            ...
            $this->drawText($XPos, $YPos, $CaptionTxt, array(
                "Align" => TEXT_ALIGN_BOTTOMLEFT
            ));
    ...
    function drawShape($X, $Y, $Shape, $PlotSize, $PlotBorder, $BorderSize, $R, $G, $B, $Alpha, $BorderR, $BorderG, $BorderB, $BorderAlpha)
    {
        if ($Shape == SERIE_SHAPE_FILLEDCIRCLE) {
            if ($PlotBorder) {
                $this->drawFilledCircle($X, $Y, $PlotSize + $BorderSize, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha
            ...
            $this->drawFilledCircle($X, $Y, $PlotSize, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
            ...
            if ($PlotBorder) {
                $this->drawFilledRectangle($X - $PlotSize - $BorderSize, $Y - $PlotSize - $BorderSize, $X + $PlotSize + $BorderSize, $Y + $PlotSize + $BorderSize, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha
            ...
            $this->drawFilledRectangle($X - $PlotSize, $Y - $PlotSize, $X + $PlotSize, $Y + $PlotSize, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
            ...
            $this->drawLine($X, $Y - $PlotSize, $X - $PlotSize, $Y + $PlotSize, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
            ));
            $this->drawLine($X - $PlotSize, $Y + $PlotSize, $X + $PlotSize, $Y + $PlotSize, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
            ));
            $this->drawLine($X + $PlotSize, $Y + $PlotSize, $X, $Y - $PlotSize, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
            ...
            $this->drawRectangle($X - $PlotSize, $Y - $PlotSize, $X + $PlotSize, $Y + $PlotSize, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
        ...
        elseif ($Shape == SERIE_SHAPE_CIRCLE)
            $this->drawCircle($X, $Y, $PlotSize, $PlotSize, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
    ...
    function drawPolygonChart($Points, $Format = "")
    {
        ...
        if (!$NoBorder) {
            foreach ($Segments as $Key => $Coords)
                $this->drawLine($Coords["X1"], $Coords["Y1"], $Coords["X2"], $Coords["Y2"], array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
