...
class pScatter
{
    ...
    function drawScatterScale($Format = "")
    {
        ...
        foreach ($Data["Axis"] as $AxisID => $AxisSettings) {
            if (isset($AxisSettings["Color"])) {
                ...
                $this->pChartObject->setFontProperties(array(
            ...
            if ($AxisSettings["Identity"] == AXIS_X) {
                if ($AxisSettings["Position"] == AXIS_POSITION_BOTTOM) {
                    ...
                    if ($Floating) {
                        ...
                        $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1 + $AxisSettings["Margin"], $AxisPos["B"], $this->pChartObject->GraphAreaX2 - $AxisSettings["Margin"], $AxisPos["B"], array(
                            "R" => $AxisR,
                            "G" => $AxisG,
                            "B" => $AxisB,
                            "Alpha" => $AxisAlpha
                        ...
                        $FloatingOffset = 0;
                        $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1, $AxisPos["B"], $this->pChartObject->GraphAreaX2, $AxisPos["B"], array(
                            "R" => $AxisR,
                            "G" => $AxisG,
                            "B" => $AxisB,
                            "Alpha" => $AxisAlpha
                    ...
                    if ($DrawArrows) {
                        $this->pChartObject->drawArrow($this->pChartObject->GraphAreaX2 - $AxisSettings["Margin"], $AxisPos["B"], $this->pChartObject->GraphAreaX2 + ($ArrowSize * 2), $AxisPos["B"], array(
                            "FillR" => $AxisR,
                            "FillG" => $AxisG,
                            "FillB" => $AxisB,
                            "Size" => $ArrowSize
                    ...
                    for ($i = 0; $i <= $AxisSettings["Rows"]; $i++) {
                        ...
                        if ($DrawXLines == ALL || in_array($AxisID, $DrawXLines)) {
                            $this->pChartObject->drawLine($XPos, $this->pChartObject->GraphAreaY1 + $FloatingOffset, $XPos, $this->pChartObject->GraphAreaY2 - $FloatingOffset, array(
                                "R" => $GridR,
                                "G" => $GridG,
                                "B" => $GridB,
                                "Alpha" => $GridAlpha,
                        ...
                        if ($DrawSubTicks && $i != $AxisSettings["Rows"])
                            $this->pChartObject->drawLine($XPos + $SubTicksSize, $YPos - $InnerSubTickWidth, $XPos + $SubTicksSize, $YPos + $OuterSubTickWidth, array(
                                "R" => $SubTickR,
                                "G" => $SubTickG,
                                "B" => $SubTickB,
                                "Alpha" => $SubTickAlpha
                        ...
                        $this->pChartObject->drawLine($XPos, $YPos - $InnerTickWidth, $XPos, $YPos + $OuterTickWidth, array(
                            "R" => $TickR,
                            "G" => $TickG,
                            "B" => $TickB,
                            "Alpha" => $TickAlpha
                        ));
                        $Bounds    = $this->pChartObject->drawText($XPos, $YPos + $OuterTickWidth + $LabelOffset, $Value, array(
                            "Angle" => $XLabelsRotation,
                            "Align" => $LabelAlign
                        ));
                    ...
                    if (isset($AxisSettings["Name"])) {
                        ...
                        $Bounds    = $this->pChartObject->drawText($XPos, $YPos, $AxisSettings["Name"], array(
                    ...
                    if ($Floating) {
                        $FloatingOffset = $YMargin;
                        $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1 + $AxisSettings["Margin"], $AxisPos["T"], $this->pChartObject->GraphAreaX2 - $AxisSettings["Margin"], $AxisPos["T"], array(
                            "R" => $AxisR,
                            "G" => $AxisG,
                            "B" => $AxisB,
                            "Alpha" => $AxisAlpha
                        ...
                        $FloatingOffset = 0;
                        $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1, $AxisPos["T"], $this->pChartObject->GraphAreaX2, $AxisPos["T"], array(
                            "R" => $AxisR,
                            "G" => $AxisG,
                            "B" => $AxisB,
                            "Alpha" => $AxisAlpha
                    ...
                    if ($DrawArrows) {
                        $this->pChartObject->drawArrow($this->pChartObject->GraphAreaX2 - $AxisSettings["Margin"], $AxisPos["T"], $this->pChartObject->GraphAreaX2 + ($ArrowSize * 2), $AxisPos["T"], array(
                            "FillR" => $AxisR,
                            "FillG" => $AxisG,
                            "FillB" => $AxisB,
                            "Size" => $ArrowSize
                    ...
                    for ($i = 0; $i <= $AxisSettings["Rows"]; $i++) {
                        ...
                        if ($DrawSubTicks && $i != $AxisSettings["Rows"])
                            $this->pChartObject->drawLine($XPos + $SubTicksSize, $YPos - $OuterSubTickWidth, $XPos + $SubTicksSize, $YPos + $InnerSubTickWidth, array(
                                "R" => $SubTickR,
                                "G" => $SubTickG,
                                "B" => $SubTickB,
                                "Alpha" => $SubTickAlpha
                        ...
                        $this->pChartObject->drawLine($XPos, $YPos - $OuterTickWidth, $XPos, $YPos + $InnerTickWidth, array(
                            "R" => $TickR,
                            "G" => $TickG,
                            "B" => $TickB,
                            "Alpha" => $TickAlpha
                ...
                if ($AxisSettings["Position"] == AXIS_POSITION_LEFT) {
                    ...
                    if ($Floating) {
                        ...
                        $this->pChartObject->drawLine($AxisPos["L"], $this->pChartObject->GraphAreaY1 + $AxisSettings["Margin"], $AxisPos["L"], $this->pChartObject->GraphAreaY2 - $AxisSettings["Margin"], array(
                            "R" => $AxisR,
                            "G" => $AxisG,
                            "B" => $AxisB,
                            "Alpha" => $AxisAlpha
                        ...
                        $FloatingOffset = 0;
                        $this->pChartObject->drawLine($AxisPos["L"], $this->pChartObject->GraphAreaY1, $AxisPos["L"], $this->pChartObject->GraphAreaY2, array(
                            "R" => $AxisR,
                            "G" => $AxisG,
                            "B" => $AxisB,
                            "Alpha" => $AxisAlpha
                    ...
                    if ($DrawArrows) {
                        $this->pChartObject->drawArrow($AxisPos["L"], $this->pChartObject->GraphAreaY1 + $AxisSettings["Margin"], $AxisPos["L"], $this->pChartObject->GraphAreaY1 - ($ArrowSize * 2), array(
                            "FillR" => $AxisR,
                            "FillG" => $AxisG,
                            "FillB" => $AxisB,
                            "Size" => $ArrowSize
                    ...
                    for ($i = 0; $i <= $AxisSettings["Rows"]; $i++) {
                        ...
                        if (($YPos != $this->pChartObject->GraphAreaY1 && $YPos != $this->pChartObject->GraphAreaY2) && ($DrawYLines == ALL || in_array($AxisID, $DrawYLines))) {
                            $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1 + $FloatingOffset, $YPos, $this->pChartObject->GraphAreaX2 - $FloatingOffset, $YPos, array(
                                "R" => $GridR,
                                "G" => $GridG,
                                "B" => $GridB,
                                "Alpha" => $GridAlpha,
                        ...
                        if ($DrawSubTicks && $i != $AxisSettings["Rows"])
                            $this->pChartObject->drawLine($XPos - $OuterSubTickWidth, $YPos - $SubTicksSize, $XPos + $InnerSubTickWidth, $YPos - $SubTicksSize, array(
                                "R" => $SubTickR,
                                "G" => $SubTickG,
                                "B" => $SubTickB,
                                "Alpha" => $SubTickAlpha
                        ...
                        $this->pChartObject->drawLine($XPos - $OuterTickWidth, $YPos, $XPos + $InnerTickWidth, $YPos, array(
                            "R" => $TickR,
                            "G" => $TickG,
                            "B" => $TickB,
                            "Alpha" => $TickAlpha
                        ));
                        $Bounds  = $this->pChartObject->drawText($XPos - $OuterTickWidth - 2, $YPos, $Value, array(
                    ...
                    if ($Floating) {
                        $FloatingOffset = $XMargin;
                        $this->pChartObject->drawLine($AxisPos["R"], $this->pChartObject->GraphAreaY1 + $AxisSettings["Margin"], $AxisPos["R"], $this->pChartObject->GraphAreaY2 - $AxisSettings["Margin"], array(
                            "R" => $AxisR,
                            "G" => $AxisG,
                            "B" => $AxisB,
                            "Alpha" => $AxisAlpha
                        ...
                        $FloatingOffset = 0;
                        $this->pChartObject->drawLine($AxisPos["R"], $this->pChartObject->GraphAreaY1, $AxisPos["R"], $this->pChartObject->GraphAreaY2, array(
                            "R" => $AxisR,
                            "G" => $AxisG,
                            "B" => $AxisB,
                            "Alpha" => $AxisAlpha
                    ...
                    if ($DrawArrows) {
                        $this->pChartObject->drawArrow($AxisPos["R"], $this->pChartObject->GraphAreaY1 + $AxisSettings["Margin"], $AxisPos["R"], $this->pChartObject->GraphAreaY1 - ($ArrowSize * 2), array(
                            "FillR" => $AxisR,
                            "FillG" => $AxisG,
                            "FillB" => $AxisB,
                            "Size" => $ArrowSize
                    ...
                    for ($i = 0; $i <= $AxisSettings["Rows"]; $i++) {
                        ...
                        if ($DrawSubTicks && $i != $AxisSettings["Rows"])
                            $this->pChartObject->drawLine($XPos - $InnerSubTickWidth, $YPos - $SubTicksSize, $XPos + $OuterSubTickWidth, $YPos - $SubTicksSize, array(
                                "R" => $SubTickR,
                                "G" => $SubTickG,
                                "B" => $SubTickB,
                                "Alpha" => $SubTickAlpha
                        ...
                        $this->pChartObject->drawLine($XPos - $InnerTickWidth, $YPos, $XPos + $OuterTickWidth, $YPos, array(
                            "R" => $TickR,
                            "G" => $TickG,
                            "B" => $TickB,
                            "Alpha" => $TickAlpha
            ...
            if ($Series["isDrawable"] == TRUE) {
                ...
                if (isset($Series["Picture"])) {
                    ...
                    if ($Family == LEGEND_FAMILY_BOX) {
                        ...
                        $this->pChartObject->drawFilledRectangle($X + 1 + $XOffset, $Y + 1 + $YOffset, $X + $BoxWidth + $XOffset + 1, $Y + $BoxHeight + 1 + $YOffset, array(
                            "R" => 0,
                            "G" => 0,
                            "B" => 0,
                            "Alpha" => 20
                        ));
                        $this->pChartObject->drawFilledRectangle($X + $XOffset, $Y + $YOffset, $X + $BoxWidth + $XOffset, $Y + $BoxHeight + $YOffset, array(
                            "R" => $R,
                            "G" => $G,
                            "B" => $B,
                            "Surrounding" => 20
                        ...
                        $this->pChartObject->drawFilledCircle($X + 1 + $IconAreaWidth / 2, $Y + 1 + $IconAreaHeight / 2, min($IconAreaHeight / 2, $IconAreaWidth / 2), array(
                            "R" => 0,
                            "G" => 0,
                            "B" => 0,
                            "Alpha" => 20
                        ));
                        $this->pChartObject->drawFilledCircle($X + $IconAreaWidth / 2, $Y + $IconAreaHeight / 2, min($IconAreaHeight / 2, $IconAreaWidth / 2), array(
                            "R" => $R,
                            "G" => $G,
                            "B" => $B,
                            "Surrounding" => 20
                        ...
                        $this->pChartObject->drawLine($X + 1, $Y + 1 + $IconAreaHeight / 2, $X + 1 + $IconAreaWidth, $Y + 1 + $IconAreaHeight / 2, array(
                            "R" => 0,
                            "G" => 0,
                            "B" => 0,
                            "Alpha" => 20,
                        ...
                        $this->pChartObject->drawLine($X, $Y + $IconAreaHeight / 2, $X + $IconAreaWidth, $Y + $IconAreaHeight / 2, array(
                            "R" => $R,
                            "G" => $G,
                            "B" => $B,
                            "Ticks" => $Ticks,
                ...
                if ($Mode == LEGEND_VERTICAL) {
                    $Lines = preg_split("/\n/", $Series["Description"]);
                    foreach ($Lines as $Key => $Value)
                        $this->pChartObject->drawText($X + $IconAreaWidth + 4, $Y + $IconAreaHeight / 2 + (($this->pChartObject->FontSize + 3) * $Key), $Value, array(
                            "R" => $FontR,
                            "G" => $FontG,
                            "B" => $FontB,
                            "Align" => TEXT_ALIGN_MIDDLELEFT
                    ...
                    $Width = "";
                    foreach ($Lines as $Key => $Value) {
                        $BoxArray = $this->pChartObject->drawText($X + $IconAreaWidth + 4, $Y + $IconAreaHeight / 2 + (($this->pChartObject->FontSize + 3) * $Key), $Value, array(
                            "R" => $FontR,
                            "G" => $FontG,
                            "B" => $FontB,
                            "Align" => TEXT_ALIGN_MIDDLELEFT
        ...
        foreach ($Points as $Key => $Point) {
            if (isset($PosArrayX[$Point]) && isset($PosArrayY[$Point])) {
                ...
                if ($DrawPoint == LABEL_POINT_CIRCLE)
                    $this->pChartObject->drawFilledCircle($X, $Y, 3, array(
                        "R" => 255,
                        "G" => 255,
                        "B" => 255,
                        "BorderR" => 0,
                ...
                elseif ($DrawPoint == LABEL_POINT_BOX)
                    $this->pChartObject->drawFilledRectangle($X - 2, $Y - 2, $X + 2, $Y + 2, array(
                        "R" => 255,
                        "G" => 255,
                        "B" => 255,
                        "BorderR" => 0,
    ...
    function drawScatterThreshold($Value, $Format = "")
    {
        ...
        if ($Data["Axis"][$AxisID]["Identity"] == AXIS_Y) {
            ...
            $this->pChartObject->drawLine($X1, $Y, $X2, $Y, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha,
            ...
            if ($Wide) {
                $this->pChartObject->drawLine($X1, $Y - 1, $X2, $Y - 1, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
            ...
            $this->pChartObject->drawLine($X, $Y1, $X, $Y2, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha,
            ...
            if ($Wide) {
                $this->pChartObject->drawLine($X - 1, $Y1, $X - 1, $Y2, array(
                    "R" => $R,
                    "G" => $G,
                    "B" => $B,
                    "Alpha" => $Alpha / $WideFactor,
    ...
    function drawScatterThresholdArea($Value1, $Value2, $Format = "")
    {
        ...
        if ($Data["Axis"][$AxisID]["Identity"] == AXIS_X) {
            ...
            $this->pChartObject->drawFilledRectangle($X1, $Y1, $X2, $Y2, array(
                "R" => $R,
                "G" => $G,
                "B" => $B,
                "Alpha" => $Alpha
            ...
            if ($Border) {
                $this->pChartObject->drawLine($X1, $Y1, $X1, $Y2, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
                ...
                $this->pChartObject->drawLine($X2, $Y1, $X2, $Y2, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
            ...
            if ($AreaName != NULL) {
                ...
                $this->pChartObject->drawText($XPos, $YPos, $AreaName, array(
                    "R" => $NameR,
                    "G" => $NameG,
                    "B" => $NameB,
                    "Alpha" => $NameAlpha,
            ...
            if ($Border) {
                $this->pChartObject->drawLine($X1, $Y1, $X2, $Y1, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
                ...
                $this->pChartObject->drawLine($X1, $Y2, $X2, $Y2, array(
                    "R" => $BorderR,
                    "G" => $BorderG,
                    "B" => $BorderB,
                    "Alpha" => $BorderAlpha,
            ...
            if ($AreaName != NULL) {
                ...
                $this->pChartObject->Shadow = $RestoreShadow;
                $this->pChartObject->drawText($YPos, $XPos, $AreaName, array(
                    "R" => $NameR,
                    "G" => $NameG,
                    "B" => $NameB,
                    "Alpha" => $NameAlpha,
