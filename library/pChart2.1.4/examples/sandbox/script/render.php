...
if ($Mode == "Render") {
    if ($g_border == "true") {
        $myPicture->drawRectangle(0, 0, $g_width - 1, $g_height - 1, array(
            "R" => 0,
            "G" => 0,
            "B" => 0
        ));
...
if ($g_title_enabled == "true") {
    if ($Mode == "Render")
        $myPicture->setFontProperties(array(
            "FontName" => "../../../fonts/" . $g_title_font,
            "FontSize" => $g_title_font_size
        ));
    else
    ...
    $TextSettings = array(
        "Align" => getTextAlignCode($g_title_align),
        "R" => $R,
        "G" => $G,
        "B" => $B
    );
...
$Settings = array(
    ...
    "GridG" => $GridG,
    "GridB" => $GridB,
    "GridAlpha" => $s_grid_alpha,
    "TickR" => $TickR,
    "TickG" => $TickG,
    "TickB" => $TickB,
    "TickAlpha" => $s_ticks_alpha,
