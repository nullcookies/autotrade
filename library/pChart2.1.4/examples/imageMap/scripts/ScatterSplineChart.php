...
for ($i = 0; $i <= 360; $i = $i + 90) {
	$myData->addPoints(rand(1, 30), "Probe 1");
}
for ($i = 0; $i <= 360; $i = $i + 90) {
	$myData->addPoints(rand(1, 30), "Probe 2");
}
...
$myData->setScatterSerieColor(0, array(
	"R" => 0,
	"G" => 0,
	"B" => 0
));
...
$myScatter->drawScatterSplineChart(array(
	"RecordImageMap" => TRUE
));
$myScatter->drawScatterPlotChart();

/* Draw the legend */
$myScatter->drawScatterLegend(260, 375, array(
