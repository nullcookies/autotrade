...
$myPicture->drawGradientArea(0, 0, 700, 20, DIRECTION_VERTICAL, array(
	"StartR" => 0,
	"StartG" => 0,
	"StartB" => 0,
	"EndR" => 50,
...
$myPicture->drawRectangle(0, 0, 699, 229, array(
	"R" => 0,
	"G" => 0,
	"B" => 0
));
...
$myPicture->setFontProperties(array(
	"FontName" => FONT_PATH . "/Silkscreen.ttf",
	"FontSize" => 6
));
$myPicture->drawText(10, 13, "drawFilledRectangle() - Transparency & colors", array(
	"R" => 255,
	"G" => 255,
	"B" => 255
));
