...
<head>
    ...
    <link rel="icon" href="<?php echo SELF_URL_NO_SCRIPT ?>process.php?img=favicon" type="image/png" />
    <link rel="shortcut icon" href="<?php echo SELF_URL_NO_SCRIPT ?>process.php?img=favicon" type="image/png" />
