...
<html lang="en">
	...
	<body>
		<div class="container container-bitmex trade">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation"><a data-toggle="tab" href="#open-orders">Opening</a></li>
			...
			<div class="tab-content">
				...
				<div id="orderbook" class="tab-pane fade">
					<div class="panel-group row">
						...
						<div id="column-right" class="col-sm-6"> 
							<div class="panel panel-default panel-orderbook2">
								<div class="panel-heading"><h3 class="panel-title">OrderBook</h3></div>
								<div class="panel-body">
									<p class="message">Loading ...</p>
								</div>
				...
				<div id="orders" class="tab-pane fade">
					<div class="panel-group row">
						...
						<div id="column-right" class="col-sm-6"> 
							<div class="panel panel-default panel-orders2">
								<div class="panel-heading"><h3 class="panel-title">Orders</h3></div>
								<div class="panel-body">
									<p class="message">Loading ...</p>
								</div>
				...
				<div id="order" class="tab-pane fade">
					<div class="panel-group row">
						...
						<div id="column-right" class="col-sm-6"> 
							<div class="panel panel-default panel-order2">
								<div class="panel-heading"><h3 class="panel-title">Order</h3></div>
								<div class="panel-body">
									<p class="message">Loading ...</p>
								</div>
